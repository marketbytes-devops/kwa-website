...
const GeneralRunningContract = () => {
      ...
      try {
        ...
        if (!useApiFiltering) {
          filtered = response.data.filter(
            (complaint) => complaint.complaint_type === "general" && complaint.department === "runningcontract"
          );
  ...
  return (
    <div className="pt-14 px-4 max-w-6xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-center">Running Contract General Complaints</h2>
...
export default GeneralRunningContract;