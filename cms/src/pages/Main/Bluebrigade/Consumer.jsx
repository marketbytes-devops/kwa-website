...
const ConsumerBlueBrigade = () => {
  ...
  useEffect(() => {
    const fetchComplaints = async () => {
      try {
        ...
        console.log("Fetched consumer complaints:", response.data);

        let filtered = response.data;
        if (!useApiFiltering) {
          filtered = response.data.filter(
            (complaint) =>
              complaint.complaint_type === "consumer" && complaint.department === "bluebrigade"
          );
  ...
  return (
    <div className="pt-14 px-4">
      <h2 className="text-2xl font-bold mb-6 text-center">BlueBrigade Consumer Complaints</h2>
...
const ConsumerBlueBrigade = () => {
  ...
  return (
    <div className="pt-14">
      <h2>BlueBrigade Consumer Complaints</h2>
