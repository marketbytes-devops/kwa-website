...
const GeneralBlueBrigade = () => {
      ...
      try {
        ...
        if (!useApiFiltering) {
          filtered = response.data.filter(
            (complaint) => complaint.complaint_type === "general" && complaint.department === "bluebrigade"
          );
  ...
  return (
    <div className="pt-4 px-4 max-w-6xl mx-auto sm:pt-14 sm:px-6">
      <h2 className="text-xl font-bold mb-4 text-center sm:text-2xl">Blue Brigade General Complaints</h2>
